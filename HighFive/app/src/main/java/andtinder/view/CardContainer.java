...
import com.example.nancy.highfive.R;
        ...
        switch (event.getActionMasked()) {
            case MotionEvent.ACTION_DOWN:
                ...
                for (int i = 0; i < mListAdapter.getCount(); i++) {
                    View view = getChildAt(mListAdapter.getCount()-1-i);

                    if (mTopCard == view) {

                        CardModel cardModel = (CardModel) getAdapter().getItem(i);
    ...
    public void missCard(float velocityX, float velocityY, final View topCard) {
        ...
        for (int i = 0; i < mListAdapter.getCount(); i++) {
            ...
            if (topCard == view) {
                ...
                cardModel = (CardModel) getAdapter().getItem(i);
            }
        }
